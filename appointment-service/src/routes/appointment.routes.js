...
router.get("/stream/my", authenticate, authorize("patient"), streamMyAppointments);
router.get("/stream/doctor", authenticate, authorize("doctor"), streamDoctorAppointments);
